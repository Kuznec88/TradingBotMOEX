...
def run() -> None:
    ...
    market_maker = BasicMarketMaker(
        ...
        move_threshold=_read_float(cfg_for_optional, "move_threshold", 2.0),
        velocity_threshold=_read_float(cfg_for_optional, "velocity_threshold", 0.0),
        delta_threshold=_read_float(cfg_for_optional, "delta_threshold", 0.0),
        imbalance_threshold=_read_float(cfg_for_optional, "imbalance_threshold", 0.2),
        normalized_delta_threshold=_read_float(cfg_for_optional, "normalized_delta_threshold", 0.03),
        score_threshold=_read_float(cfg_for_optional, "score_threshold", 0.72),
        w_spread=_read_float(cfg_for_optional, "w_spread", 0.30),
        w_move=_read_float(cfg_for_optional, "w_move", 0.40),
        w_ndelta=_read_float(cfg_for_optional, "w_ndelta", 0.30),
        ...
        fallback_min_move_ticks=_read_float(cfg_for_optional, "fallback_min_move_ticks", 0.75),
        fallback_min_ndelta=_read_float(cfg_for_optional, "fallback_min_ndelta", 0.015),
