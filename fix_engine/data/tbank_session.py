...
from fix_engine.config.constants import MD_HEALTH_POLL_INTERVAL_SEC
...
def run_tbank_paper_session(
    *,
    ...
    """Старт стрима котировок T-Bank и сопутствующих сервисов до завершения сессии."""
    ...
    from fix_engine.data.tbank_stream import run_tbank_sandbox_market_data
    ...
    md_health = MdHealthMonitor(
        ...
        logger=logger,
        interval_sec=MD_HEALTH_POLL_INTERVAL_SEC,
    )
    md_health.start()
